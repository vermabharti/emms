...
// Login Web service calling method
  ...
  Future<dynamic> _loginuser() async {
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      Response response =
          await ioClient.post(P_LOGIN_URL, headers: headers, body: formData);
...
// fetch username from web service method
...
// Launch the C-DAC web page in App footer  
