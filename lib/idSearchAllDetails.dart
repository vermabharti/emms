...
class _MyPageState extends State<ViaIdSearch> {
  ...
  Future<dynamic> _getActiveComplaintDetails() async {
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      Response response = await ioClient.post(P_ACTIVE_COMPLAINT,
  ...
  // Get Problem Decsription Method
  ...
  Future<List<dynamic>> _getProblemDescriptionName() async {
    ...
    Response response = await ioClient.post(P_PROBLEM_DESCRIPTION,
        headers: headers, body: formData);
  ...
  Future<List<dynamic>> _getContactName() async {
    ...
    List<dynamic> listtt = ['1', 'other'];
    Response response =
        await ioClient.post(P_CONTACT_PERSON, headers: headers, body: formData);
  ...
  Future<List<dynamic>> _getProblemSolutionName() async {
    ...
    Response response = await ioClient.post(P_PROBELM_SOLUTION,
        headers: headers, body: formData);
  ...
  // Default TextFields for Static Values
  ...
  void initState() {
    ...
    print('${widget.equipHeading}, ${widget.equipList}');
    super.initState();
  }
                        ...
                        child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text: '${widget.equipHeading[0]} : ',
                                      style: datastyle,
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: ' ${widget.equipList[0][0]}',
                                            style: textstyle),
                                      ]),
                                ),
                              ),
                              Container(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text: '${widget.equipHeading[1]} : ',
                                      style: datastyle,
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: ' ${widget.equipList[0][1]}',
                                            style: textstyle),
                                      ]),
                                ),
                              ),
                              Container(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text: '${widget.equipHeading[2]} : ',
                                      style: datastyle,
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: ' ${widget.equipList[0][2]}',
                                            style: textstyle),
                                      ]),
                                ),
                              ),
                              Container(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text: '${widget.equipHeading[3]} : ',
                                      style: datastyle,
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: ' ${widget.equipList[0][3]}',
                                            style: textstyle),
                                      ]),
                                ),
                              ),
                              Container(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text: '${widget.equipHeading[4]} : ',
                                      style: datastyle,
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: ' ${widget.equipList[0][4]}',
                                            style: textstyle),
                                      ]),
                                ),
                              ),
                              Container(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                      text: '${widget.equipHeading[5]} : ',
                                      style: datastyle,
                                      children: <TextSpan>[
                                        TextSpan(
                                            text: ' ${widget.equipList[0][5]}',
                                            style: textstyle),
                                      ]),
                                ),
                              ),
