...
class _MyPageState extends State<SearchEquipment> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController searchid = TextEditingController();
  String _id, qrCodeResult;
  bool apiCall = false;
  ScaffoldState scaffold;

  // fetch Method of Equipment's details
  ...
  Future<dynamic> _getEquipmentDetails() async {
    ...
    if (connectivityResult == ConnectivityResult.mobile ||
      ...
      Response response = await ioClient.post(P_EQUIPMENT_DETAILS,
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => ViaIdSearch(
                  ...
                  // pass the equipment related data to the next screen via navigator widget
                  institute: equipmentlist["dataValue"][0][14],
                  department: equipmentlist["dataValue"][0][15],
                  equipmentname: equipmentlist["dataValue"][0][16],
                  equipmentmodel: equipmentlist["dataValue"][0][17],
                  preId: equipmentlist["dataValue"][0][18],
                  barcodeId: barcode)),
        );
      }
    } else {
